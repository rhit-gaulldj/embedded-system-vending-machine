...
#define STEPPER_TIMER                   2000000
#define STEPPER_STEPS_PER_REV           64*64
#define STEP_SEQ_CNT                    8
#define INIT_PERIOD                     (STEPPER_TIMER*60)/(10*STEPPER_STEPS_PER_REV)
...
extern void setStepperSpeed(uint32_t rpm, uint32_t clock);
